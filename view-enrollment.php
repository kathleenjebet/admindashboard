...
while($fetchStudentsRecords=mysqli_fetch_array($sqlFetchStudent))
{
    ...
    $emailaddress=$fetchStudentsRecords['emailaddress'];
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">Phone Number: <span class="float-right badge badge-info" > <?php echo $emailaddress ?></span></li>
                </ul>
